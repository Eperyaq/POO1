...
fun main() {
    ...
    println("El área del rectangulo es ${miRectangulo.calcularArea(20.0, 10.0)}")
    println("El perímetro de mi rectangulo es ${miRectangulo.calcularPerímetro(20.0, 10.0)}")

    var tuRectangulo = Rectangulo(12.5, 22.0)
    println("El area de TU rectangulo es ${tuRectangulo.calcularArea(12.5, 22.0)}")
    println("El perimetro de TU rectangulo es ${tuRectangulo.calcularPerímetro(12.5, 22.0)}")
}